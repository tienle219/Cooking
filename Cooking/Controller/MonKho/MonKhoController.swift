...
import UIKit
import SQLite
class MonKhoController: BaseController,  UITableViewDelegate, UITableViewDataSource {
...
extension MonKhoController {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.updateContentCell(dish: arrMonKho[indexPath.row])
